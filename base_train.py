...
class ModelTrain:
    ...
    def __init__(self, pretrained_model_name_or_path, label_encoder, X_train, X_test, X_valid, y_train, y_test, y_valid, k_folds=1):
    ...
    def train(self, _model, _config, _train_loader, _validation_loader, _y_validation_tensor, fold=None):
        ...
        for epoch in range(epochs):
            ...
            tqdm_valid_loader = tqdm(
                _validation_loader,
                desc=f"Evaluating test dataset of {len(_validation_loader.dataset)} instances"
            )
